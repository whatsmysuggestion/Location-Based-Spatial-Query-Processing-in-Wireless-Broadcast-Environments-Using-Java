 ...
 * @author  Admin
 */
public class MobileHost2 extends javax.swing.JFrame {
	Connection con;
    Statement st;
    ServerSocket ss5;
    ServerSocket ss6;
    ...
    public MobileHost2() {
		...
		try {
                  ss6 = new ServerSocket(2222);

				ss5 = new ServerSocket(4445);

				ss7 = new ServerSocket(8282);
	 ...
	 public void prtRecv()
	{
	 while(true)
			...
			try	{
						...
						JOptionPane.showMessageDialog(this,getport);
...
public void prefinalres()
	{
			try	{
						...
						System.out.println("Comes to prefinal");
						DataInputStream displc = new DataInputStream(s4.getInputStream());
...
double hosttime = System.currentTimeMillis();
System.out.println("From Neighbour Host"+hosttime);
try
{
	if(strfinal1.equals("1111"))
	{
		String strfinal = d.retriveFinalrst("select Results from MH2 where Location='"+strfinal2+"' and Criteria='"+strfinal3+"' ");
		System.out.println("---------------->"+strfinal);
		s5 = new Socket("localhost",8181);
		DataOutputStream doutff1 =  new DataOutputStream(s5.getOutputStream());
		doutff1.writeUTF(strfinal);
	...
	}else if(strfinal1.equals("3333"))
	{
		String strfinal = d.retriveFinalrst("select Results from MH2 where Location='"+strfinal2+"' and Criteria='"+strfinal3+"' ");
		System.out.println("---------------->"+strfinal);
		s5 = new Socket("localhost",8383);
		DataOutputStream doutff3 =  new DataOutputStream(s5.getOutputStream());
